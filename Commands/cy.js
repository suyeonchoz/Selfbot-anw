module.exports = {
    ...
    run: async (client, message, handler, prefix, MyID) => {
        try {
            message.edit(`https://tenor.com/view/cats-toby-the-cat-nod-yes-yes-yes-hooman-gif-17105827`).catch(err => message.reply(`https://tenor.com/view/cats-toby-the-cat-nod-yes-yes-yes-hooman-gif-17105827`));
        } catch (err) {
            return void(0);
        }
    }
